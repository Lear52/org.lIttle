...
public class NullProxyFFHandler extends ChannelInboundHandlerAdapter {
       private static final Logger      logger = LoggerFactory.getLogger(NullProxyFFHandler.class);

       private Channel      out_channel;
       
      
       public NullProxyFFHandler(Channel   out_channel) {
