...
public class SearchTermBuilder {
       ...
       public static SearchTermBuilder create(final SearchKey key) {
              ...
              switch (key) {
                  ...
                  case FROM:
                      ...
                      break;
                  case NEW:
                      builder = createSearchTermBuilder(new AndTerm(createFlagSearchTerm("RECENT", true), createFlagSearchTerm("SEEN", false)));
                      break;
                  case OLD:
       ...
       public SearchTerm build() {return null;};
       ...
       public String toString() {
           return "SearchTermBuilder{" + "key=" + key +  ", parameters=" + parameters +'}';
       }
