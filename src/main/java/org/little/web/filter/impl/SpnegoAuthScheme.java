...
public class SpnegoAuthScheme {
       ...
       public SpnegoAuthScheme(final String authScheme, final String authToken) {
           ...
           if (null == authToken || authToken.isEmpty()) this.ntlm = false;
           else                                         this.ntlm = authToken.startsWith(Constants.NTLM_PROLOG);
        ...
        */
       public boolean isBasicScheme() { return this.basicScheme; }
        ...
        */
       public boolean isNegotiateScheme() { return this.negotiateScheme; }
       /**
        * Returns true if NTLM.
        * 
        * @return true if Servlet Filter received NTLM token
        */
       boolean isNtlmToken() {return this.ntlm;}
