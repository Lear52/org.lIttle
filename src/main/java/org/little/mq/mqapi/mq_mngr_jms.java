...
public class mq_mngr_jms extends mq_mngr{
       private static final Logger log = LoggerFactory.getLogger(mq_mngr_jms.class);

       public  mq_mngr_jms(){}
      
       public mq_mngr_jms(String _qmname) {
              super(_qmname);
       }
       public mq_mngr_jms(String _qmname,String _host,int _port,String _channel) {
