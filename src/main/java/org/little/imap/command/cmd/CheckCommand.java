 ...
 *
 */
public class CheckCommand  extends ImapCommand {
       private static final Logger logger = LoggerFactory.getLogger(CheckCommand.class);

       public static final String NAME = "CHECK";
       public static final String ARGS = null;

       public CheckCommand(String _tag, String _command, List<ImapCommandParameter> _parameters) { super(_tag,_command,_parameters);}
